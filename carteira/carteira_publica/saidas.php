...
<html lang="pt-br">
  <head>
    ...
    function edita(id){
      location.href = 'registro.php?ex=2&acao=edita&id='+id
    }
    </script>
  ...
  <body>
    ...
    <div id="content">
    <h2 id="tituloContent" >Saídas</h2>

      <div class="ContentHeader">
        <form class="mesAno" name="formSelect" id="formSelect" action="card_controller.php?p=s&acao=filtrar" method="POST">
